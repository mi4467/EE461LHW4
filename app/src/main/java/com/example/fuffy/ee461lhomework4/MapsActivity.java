...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
        ...
        Button enter = findViewById(R.id.enter_location_button_maps);
    ...
    public void resetText(Address a){
        ...
        TextView textView = findViewById(R.id.first_extra_credit);
        textView.setText(newText);
    }


    public void search()  {
        EditText location = findViewById(R.id.location_text_box_maps);
